...
class CouponTest {
    ...
    void issue_2() {
        ...
        Assertions.assertThat(couponIssueException.getErrorCode()).isEqualTo(INVALID_COUPON_ISSUE_QUANTITY);
    }
    ...
    void issue_3() {
        ...
        //when
        CouponIssueException couponIssueException = assertThrows(CouponIssueException.class, coupon::issue);
        Assertions.assertThat(couponIssueException.getErrorCode()).isEqualTo(INVALID_COUPON_ISSUE_DATE);
    }
}